...
export const createStripeAccount = payoutDetails => (dispatch, getState, sdk) => {
  ...
  // If you are using older version than '2019-01-19'
  // edit 'useNewStripeAPIversion' config in the stripe-config.js

  const isNewAPI = config.stripe.useNewStripeAPIversion;
